...
class WPILOGReader(LogReplaySource):
    ...
    Note: only reads logs generated by PyKit's WPILOGWriter (extra header must equal "PyKit").
    """
                    ...
                    if entry == self.timestampKey:
                        ...
                        match entryType:
                            ...
                            case LogValue.LoggableType.Boolean:
                                table.putValue(entry, LogValue.withType(entryType, record.getBoolean(), customType))
                            case LogValue.LoggableType.Integer:
                                table.putValue(entry, LogValue.withType(entryType, record.getInteger(), customType))
                            case LogValue.LoggableType.Float:
                                table.putValue(entry, LogValue.withType(entryType, record.getFloat(), customType))
                            case LogValue.LoggableType.Double:
                                table.putValue(entry, LogValue.withType(entryType, record.getDouble(), customType))
                            case LogValue.LoggableType.String:
                                table.putValue(entry, LogValue.withType(entryType, record.getString(), customType))
                            case LogValue.LoggableType.BooleanArray:
                                table.putValue(entry, LogValue.withType(entryType, record.getBooleanArray(), customType))
                            case LogValue.LoggableType.IntegerArray:
                                table.putValue(entry, LogValue.withType(entryType, record.getIntegerArray(), customType))
                            case LogValue.LoggableType.FloatArray:
                                table.putValue(entry, LogValue.withType(entryType, record.getFloatArray(), customType))
                            case LogValue.LoggableType.DoubleArray:
                                table.putValue(entry, LogValue.withType(entryType, record.getDoubleArray(), customType))
                            case LogValue.LoggableType.StringArray:
                                table.putValue(entry, LogValue.withType(entryType, record.getStringArray(), customType))
